...
const slug = "product-manager-cover-letter";

const pageData = {
  title: "Product Manager Cover Letter - 2026 Examples & Template | AI Resume Builder",
  h1: "Product Manager Cover Letter: Examples & Template",
  intro: `A strong product manager cover letter can set you apart from hundreds of applicants. It needs to demonstrate your strategic thinking, cross-functional leadership, data-driven decision making, and product sense — all in a few paragraphs.`,
};
...
const faqItems = [
  { question: "How long should a product manager cover letter be?", answer: `Keep it to 3-4 paragraphs, around 300-400 words. Be concise but impactful. Focus on your most relevant achievements and why you are excited about this specific product and company.` },
  { question: "What should a PM cover letter include?", answer: `Include your product philosophy, a specific achievement with metrics, your understanding of the company's product, and why you are the right fit. Show strategic thinking and cross-functional leadership experience.` },
  { question: "How can our AI resume builder help?", answer: `Our AI resume builder creates professional, ATS-optimized product manager cover letter content in seconds. Just tell us about your experience and we handle the rest. No templates, no formatting headaches — just a great resume ready to download.` },
];
