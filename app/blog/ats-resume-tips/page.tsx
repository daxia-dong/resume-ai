...
export const metadata: Metadata = {
  title: "ATS Resume Tips: How to Make Your Resume Pass Applicant Tracking Systems",
  description: "Learn how to optimize your resume for ATS systems. Tips on keywords, formatting, file types, and common mistakes that get resumes rejected by automated screeners.",
};

const faqItems = [
  { question: "What is the most important thing for ATS resume optimization?", answer: "The most important factor is relevance. Your resume or cover letter must directly address the requirements in the job description. Use the same keywords and phrases the employer uses to ensure ATS systems and recruiters see you as a strong match." },
      ...
      <article className="min-h-screen bg-black text-white">
        <div className="max-w-3xl mx-auto p-8">
          <nav className="text-sm text-gray-400 mb-8">
            ...
            <span className="text-gray-300">ATS Resume Tips: Pass Applicant Tracking Systems Every Time</span>
          </nav>
          ...
          <h1 className="text-4xl font-bold leading-tight mb-4">ATS Resume Tips: Pass Applicant Tracking Systems Every Time</h1>
          <p className="text-lg text-gray-400 mb-8">Learn how to optimize your resume for ATS systems. Tips on keywords, formatting, file types, and common mistakes that get resumes rejected by automated screeners.</p>

          <div className="bg-gray-900 p-6 rounded-lg mb-12">
            <h2 className="text-lg font-semibold mb-3">Table of Contents</h2>
            <ol className="space-y-2 text-gray-400 text-sm">
              <li><span className="text-white">1.</span> Why ATS resume optimization Matters</li>
          ...
          <section className="text-gray-300 space-y-4">
            <h2 className="text-2xl font-semibold text-white">Why ATS resume optimization Matters</h2>
