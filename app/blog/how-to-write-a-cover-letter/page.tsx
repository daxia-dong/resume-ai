...
export const metadata: Metadata = {
  title: "How to Write a Cover Letter in 2026: Examples & Expert Tips",
  description: "Learn how to write a cover letter that gets noticed. Includes examples for software engineers, product managers, and other tech professionals.",
};

const faqItems = [
  { question: "What is the most important thing for cover letter writing?", answer: "The most important factor is relevance. Your resume or cover letter must directly address the requirements in the job description. Use the same keywords and phrases the employer uses to ensure ATS systems and recruiters see you as a strong match." },
      ...
      <article className="min-h-screen bg-black text-white">
        <div className="max-w-3xl mx-auto p-8">
          <nav className="text-sm text-gray-400 mb-8">
            ...
            <span className="text-gray-300">How to Write a Cover Letter in 2026</span>
          </nav>
          ...
          <h1 className="text-4xl font-bold leading-tight mb-4">How to Write a Cover Letter in 2026</h1>
          <p className="text-lg text-gray-400 mb-8">Learn how to write a cover letter that gets noticed. Includes examples for software engineers, product managers, and other tech professionals.</p>

          <div className="bg-gray-900 p-6 rounded-lg mb-12">
            <h2 className="text-lg font-semibold mb-3">Table of Contents</h2>
            <ol className="space-y-2 text-gray-400 text-sm">
              <li><span className="text-white">1.</span> Why Cover letter writing Matters</li>
          ...
          <section className="text-gray-300 space-y-4">
            <h2 className="text-2xl font-semibold text-white">Why Cover letter writing Matters</h2>
          ...
          <section className="mt-16">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              <Link key="product-manager-cover-letter" href="/product-manager-cover-letter" className="bg-gray-900 p-4 rounded-lg hover:bg-gray-800"><h3 className="font-medium capitalize">product manager cover letter</h3><p className="text-sm text-gray-400 mt-1">View guide</p></Link>
              ...
              <Link key="entry-level-software-engineer-resume" href="/entry-level-software-engineer-resume" className="bg-gray-900 p-4 rounded-lg hover:bg-gray-800"><h3 className="font-medium capitalize">entry level software engineer resume</h3><p className="text-sm text-gray-400 mt-1">View guide</p></Link>
              <Link key="how-to-write-a-software-engineer-resume" href="/how-to-write-a-software-engineer-resume" className="bg-gray-900 p-4 rounded-lg hover:bg-gray-800"><h3 className="font-medium capitalize">how to write a software engineer resume</h3><p className="text-sm text-gray-400 mt-1">View guide</p></Link>
            </div>
          </section>
