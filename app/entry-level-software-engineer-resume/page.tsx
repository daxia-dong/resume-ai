...
const slug = "entry-level-software-engineer-resume";

const pageData = {
  title: "Entry Level Software Engineer Resume - No Experience Guide | AI Resume Builder",
  h1: "Entry Level Software Engineer Resume: Complete Guide",
  intro: `Landing your first software engineering role is challenging. Without years of experience, your resume needs to highlight your projects, internships, technical skills, and potential. This guide shows you exactly how to structure an entry level software engineer resume that gets noticed.`,
};
...
const faqItems = [
  { question: "What should an entry level software engineer put on their resume?", answer: `Highlight your education, projects, internships, technical skills, and relevant coursework. Include a strong projects section with 2-3 significant projects that demonstrate your coding ability. If you have open source contributions or hackathon experience, include those too.` },
  { question: "How do I write a resume with no experience?", answer: `Focus on projects, coursework, and transferable skills. Create a Projects section with detailed descriptions of your best work. Include your GitHub profile, participate in hackathons, contribute to open source, and consider internships to build experience.` },
  { question: "How can our AI resume builder help?", answer: `Our AI resume builder creates professional, ATS-optimized entry level software engineer resume content in seconds. Just tell us about your experience and we handle the rest. No templates, no formatting headaches — just a great resume ready to download.` },
];
